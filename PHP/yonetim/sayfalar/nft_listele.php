...
if(g('islem')=="sil")
{
	...
	$sss_sil_sorgu = Sorgu("DELETE FROM nft WHERE id='$id'");
...
<div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            <small><i class="fa fa-edit"></i> NFT Listesi</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="index.html"><i class="fa fa-home"></i> Anasayfa</a></li>
            <li class="active">NFT Listesi</li>
          </ol>
        </section>
          ...
          <div class="row">
            <div class="col-xs-12">
              <div class="box">
                ...
                <a href="nft-ekle.html" class="btn bg-navy margin"><i class="fa fa-plus"></i> NFT Ekle</a>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-hover">
                    ...
                    <tbody>
					<?php $sssSorgu = Sorgu("SELECT * FROM nft ORDER BY id DESC");
					$say = 1;
					while($sssSonuc = Sonuc($sssSorgu)){?>
                      <tr>
                        ...
                        <a href="?islem=sil&id=<?php echo $sssSonuc->id;?>" title="Sil" class="btn btn-danger  btn-xs" onclick="return confirm('Silmek istediğinize emin misiniz ?')" id="remove-all">
						 ...
						 <a href="nft-ekle.html?islem=duzenle&id=<?php echo $sssSonuc->id;?>" class="btn btn-info btn-xs" title="Düzenle" id="add-sticky">
						 Düzenle
						 </a>
                        </td>
                      </tr>
