...

{
	...
	$sayfa_onay_sorgu = Sorgu("UPDATE siparisler SET durum=1 WHERE id='$id'");

	

	$bilgi = '	 <div class="alert alert-success">

										Sıpariş başarı ile onaylandı !
...

{
	...
	$sayfa_onay_sorgu = Sorgu("UPDATE siparisler SET siparisdurumu=1 WHERE id='$id'");
...

{
	...
	$sayfa_onay_sorgu = Sorgu("UPDATE siparisler SET siparisdurumu=2 WHERE id='$id'");
...

{
	...
	$sayfa_onay_sorgu = Sorgu("UPDATE siparisler SET siparisdurumu=3 WHERE id='$id'");
              ...
              <div class="box">
                ...
                <div class="box-body">
                  ...
                  <table id="example1" class="table table-bordered table-hover">
					...
					<?php $SiparisSorgu = Sorgu("SELECT * FROM siparisler ORDER BY id DESC");
               ...
               <!--          <a href="?islem=onay&id=<?php echo $SiparisSonuc->id;?>" title="Onayla" class="btn btn-success btn-xs" onclick="return confirm('Sıparişi onaylamak istediğinize emin misiniz ?')" id="remove-all">
