...

{
    ...
    echo 'Lisanssız Kullanım Tespiti!';
...

{
    ...
    $Sorgu = Sorgu("SELECT * FROM marka_kategori WHERE durum = '1' ORDER BY id DESC");
...

    {
        ...
        echo "Markalar/$Sonuc->seo.html";

        echo "\"><img src=\"uploads/markakategori/kucuk/";
