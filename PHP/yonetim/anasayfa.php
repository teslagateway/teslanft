...
<html>
  ...
  <body class="layout-boxed fixed skin-blue">
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="anasayfa.html" class="logo"><b>TeslaGate ® | </b>Panel</a>
   ...
   <!---------------------------------------------------------------------------->
            ...
            <li class="treeview <?php echo aktif("satici-ekle.html"); ?> <?php echo aktif("satici-listele.html"); ?>  <?php echo aktif("oranlar-listesi.html"); ?>">
              ...
              <a href="#">
                ...
                <i class="fa fa-tasks"></i> <span>Satıcı Yönetimi</span>
              ...
              <ul class="treeview-menu">
                ...
                <li class="<?php echo aktif("satici-ekle.html"); ?>">



                	<a href="satici-ekle.html"><i class="fa fa-circle-o"></i> Yeni Satıcı Ekle</a>
                ...
                <li class="<?php echo aktif("satici-listele.html"); ?>">



                	<a href="satici-listele.html"><i class="fa fa-circle-o"></i> Satıcı Listesi</a>

                </li>



                <li class="<?php echo aktif("oranlar-listesi.html"); ?>">



                	<a href="oranlar-listesi.html"><i class="fa fa-circle-o"></i> Satış Oranları</a></li>
 ...
 <!---------------------------------------------------------------------------->
            ...
            <li class="treeview <?php echo aktif("uye-ekle.html"); ?> <?php echo aktif("uye-listele.html"); ?>">
              ...
              <a href="#">
                ...
                <i class="fa fa-tasks"></i> <span>Üye Yönetimi</span>
              ...
              <ul class="treeview-menu">
                ...
                <li class="<?php echo aktif("uye-ekle.html"); ?>">



                	<a href="uye-ekle.html"><i class="fa fa-circle-o"></i> Yeni Üye Ekle</a>
                ...
                <li class="<?php echo aktif("uye-listele.html"); ?>">



                	<a href="uye-listele.html"><i class="fa fa-circle-o"></i> Üye Listesi</a></li>
            ...
            <li class="treeview <?php echo aktif("ticket-ekle.html"); ?> <?php echo aktif("ticket-listele.html"); ?>">
              ...
              <a href="#">
                ...
                <i class="fa fa-ticket"></i> <span>Ticket Yönetimi</span>
              ...
              <ul class="treeview-menu">
                ...
                <li class="<?php echo aktif("ticket-listele.html"); ?>">



                	<a href="ticket-listele.html"><i class="fa fa-circle-o"></i> Ticket Listesi</a>
            ...
            <li class="treeview <?php echo aktif("hesap-ekle.html"); ?> <?php echo aktif("hesap-listele.html"); ?> <?php echo aktif("kapida-listele.html"); ?> <?php echo aktif("paypal-guncelle.html"); ?> <?php echo aktif("kart-guncelle.html"); ?>">
              ...
              <ul class="treeview-menu">
				...
				<li class="<?php echo aktif("kart-guncelle.html"); ?>">
                	...
                	<a href="kart-guncelle.html"><i class="fa fa-circle-o"></i> Coinbase API</a>
	...
	if(isset($_GET['sayfa'])){
		...
		require_once("sayfalar/nft_ekle.php");
		...
		require_once("sayfalar/nft_listele.php");
		...
		require_once("sayfalar/siparis_durumu.php");
		...
		case 'marka-kategori-ekle';



		require_once("sayfalar/marka_kategori_ekle.php");
		...
		case 'marka-kategori-listele';



		require_once("sayfalar/marka_kategori_listele.php");
		...
		require_once("sayfalar/yorum_listele.php");
		...
		require_once("sayfalar/satici_ekle.php");
		...
		require_once("sayfalar/satici_listele.php");
		...
		require_once("sayfalar/uye_ekle.php");
		...
		require_once("sayfalar/satis_orani.php");
		...
		case 'oranlar-listesi';



		require_once("sayfalar/oranlar_listesi.php");
		...
		require_once("sayfalar/uye_listele.php");
