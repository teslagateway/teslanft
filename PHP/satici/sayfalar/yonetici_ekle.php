...
if($_GET['islem']=="duzenle")
{
	$sayfaid = $_GET['id'];	
	$durum = "duzenle" ;
	$Yonetici = Sonuc(Sorgu("SELECT * FROM ogretmen WHERE yonetici_id='$sayfaid'"));
}
                ...
                <form method="post" action="" enctype="multipart/form-data">
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="adsoyad" value="<?php echo $Yonetici->ogretmen_ad_soyad;?>" id="adsoyad" placeholder="Ad Soyad">
                    </div>
