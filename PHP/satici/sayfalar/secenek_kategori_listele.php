...
if(g('islem')=="sil")
{
	...
	$kategori_sil_sorgu = Sorgu("DELETE FROM secenek_kategori WHERE id='$id'");
...
<div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            <small><i class="fa fa-sitemap"></i> Seçenek Kategori Listesi</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="index.html"><i class="fa fa-home"></i> Anasayfa</a></li>
            <li class="active">Seçenek Kategori Listesi</li>
          </ol>
        </section>
          ...
          <div class="row">
            <div class="col-xs-12">
              <div class="box">
                ...
                <a href="secenek-kategori-ekle.html" class="btn bg-navy margin"><i class="fa fa-plus"></i> Seçenek Kategori Ekle</a>
                </div><!-- /.box-header -->
                <div class="box-body">
					...
					while($KategoriSonuc = Sonuc($KategoriSorgu)){?>
                      <tr>
                        ...
                        <a href="?islem=sil&id=<?php echo $KategoriSonuc->id;?>" title="Sil" class="btn btn-danger  btn-xs" onclick="return confirm('Silmek istediğinize emin misiniz ?')" id="remove-all">
						 ...
						 <a href="secenek-kategori-ekle.html?islem=duzenle&id=<?php echo $KategoriSonuc->id;?>" class="btn btn-info btn-xs" title="Düzenle" id="add-sticky">
						 Düzenle
						 </a>
                        </td>
                      </tr>
