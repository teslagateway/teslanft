...
if(g('islem')=="sil")
{
	...
	$slider_sil_sorgu = Sorgu("DELETE FROM ogretmen WHERE yonetici_id='$id'");
              ...
              <div class="box">
                ...
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-hover">
                    ...
                    <tbody>
        <?php $YoneticiSorgu = Sorgu("SELECT * FROM ogretmen ORDER BY yonetici_id DESC");
        while($YoneticiSonuc = Sonuc($YoneticiSorgu)){?>
                      <tr>
                        <td><?php echo $YoneticiSonuc->yonetici_id; ?></td>
                        <td><?php echo $YoneticiSonuc->ogretmen_ad_soyad; ?></td>
