              ...
              <div class="col-md-12">
                ...
                <form method="post" action="" enctype="multipart/form-data">
                 ...
                 <div class="form-group" >
                   ...
                   <!-------------------------------------------------------------------------------------->
                 <div class="form-group"  id="indirimgoster" <?php echo($UrunSonuc->indirim == "1" ? 'style="display:block;"' : 'style="display:none;"');?>>
                    <label>İndirimli Fiyatı</label>
                    <div class="input-group">
                    <span class="input-group-addon">ETH</span>
                    	<input type="text" class="form-control" name="ifiyat" value="<?php echo $UrunSonuc->ifiyat;?>" id="ifiyat" placeholder="0,00">
                  </div>
                  </div>
					<div class="form-group">
