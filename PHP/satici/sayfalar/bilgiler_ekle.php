...
if(p('sayfaadi') && g('islem')=="")
{
	...
	$upload->process("../uploads/bilgiler");
	if ($upload->processed){
	...
	$sayfa_sorgu	=	mysql_query("INSERT INTO bilgiler SET
										adi		=	'$sayfaadi', 
										resim	=	'$sayfaresim',
										seo		=	'$seo', 
										aciklama=	'$aciklama',
...
if(p('sayfaadi') && g('islem')=="duzenle")
{
	...
	if($sayfaresim!="")
	{
		$resim_bul=mysql_fetch_object(mysql_query("SELECT * FROM bilgiler WHERE id='$d_id'"));
		$resim_sil=unlink("../uploads/bilgiler/".$resim_bul->resim);
	
		$sayfa_duzenle_sorgu	=	Sorgu("UPDATE bilgiler SET 
											adi		=	'$sayfaadi', 
											resim	=	'$sayfaresim', 
											aciklama=	'$aciklama',
											seo		=	'$seo', 
...
if($_GET['islem']=="duzenle")
{
	...
	$SayfaSonuc = Sonuc(Sorgu("SELECT * FROM bilgiler WHERE id='$sayfaid'"));
...
<div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            <small><i class="fa fa-edit"></i> Bilgiler Sayfa Ekle / Düzenle</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="index.html"><i class="fa fa-home"></i> Anasayfa</a></li>
            <li class="active"> Bilgiler Sayfa Ekle / Düzenle</li>
          </ol>
        </section>
        <!-- Main content -->
                  ...
                  <div class="box-body">
                    ...
                    <div class="form-group ">
                                   ...
                                   <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;">
                                    ...
                                    <img src="../uploads/bilgiler/<?php echo $SayfaSonuc->resim;?>" style="width: 200px; height: 200px;" alt="" />
                                    <?php } else { ?>
